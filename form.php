...
if(isset($_POST['submit'])){
    ...
    if(!empty($email) && !empty($name) && !empty($subject) && !empty($message)){
        ...
        if(filter_var($email, FILTER_VALIDATE_EMAIL) === false){
            ...
            $toEmail = 'adnan.bangun@gmail.com'; // Ganti dengan alamat email yang Anda inginkan
            $emailSubject = 'Request Deposit '.$name;
            $htmlContent = '<h2>Permintaan via www.lintastrading.com</h2>
                <h4>Name</h4><p>'.$name.'</p>
